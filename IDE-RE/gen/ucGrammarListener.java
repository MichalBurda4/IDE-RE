...
public interface ucGrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ucGrammar#notify}.
	 * @param ctx the parse tree
	 */
	void enterNotify(ucGrammar.NotifyContext ctx);
	/**
	 * Exit a parse tree produced by {@link ucGrammar#notify}.
	 * @param ctx the parse tree
	 */
	void exitNotify(ucGrammar.NotifyContext ctx);
	/**
